  ...
  return (
    <div className='py-20'>
      <h1 className='heading'>
        A small selection of <span className='text-purle'>recent projects</span>
      </h1>
      ...
      <div className='flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-2 mt-10'>
        {projects.map(({ id, title, des, img, iconLists, link }) => (
          <div
            key={id}
            className='sm:h-[41rem] h-[32rem] mg:min-h-[32.53rem] flex items-center justify-center sm:w-[570px] w-[80vw]'
          >
            <PinContainer title={link} href={link}>
              <div className='relative flex items-center justify-center sm:w-[570px] w-[80vw] overflow-hidden h-[40vh] lg:h-[30vh] mb-10'>
                ...
                <Image src={img} alt={title} fill className='z-10 absolute bottom-0 object-contain object-bottom' />
              </div>
              ...
              <div className='flex items-center justify-between mt-7 mb-3'>
                ...
                <div className='flex justify-center items-center'>
                  <p className='flex lg:text-text-xl md:text-sm text-purle'>
                    Live Site
                  </p>
